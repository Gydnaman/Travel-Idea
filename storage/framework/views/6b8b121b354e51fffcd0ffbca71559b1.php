...
?>
<div class="detail-hero" style="background-image: url('<?php echo e($bgUrl); ?>');">
                                    ...
                                    <div class="bg-light rounded-4 p-3 position-relative">
                                        <div class="d-flex justify-content-between align-items-start mb-1">
                                            ...
                                            <div class="text-warning small">
                                                <?php for($i = 0; $i < 5; $i++): ?>
                                                    <?php $isFilled = $i < $comment->rating; ?>
                                                    <i class="bi bi-star<?php echo e($isFilled ? '-fill' : ''); ?>"></i>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    ...
    function buildCommentHtml(comment) {
        ...
        let isAuth = "<?php echo e(Auth::check() ? '1' : ''); ?>" === "1";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\HKU\ICOM6034\TravelIdeas\GroupProject\resources\views/travel_ideas/show.blade.php ENDPATH**/ ?>