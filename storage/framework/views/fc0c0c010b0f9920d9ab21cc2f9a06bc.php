                    ...
                    <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden" style="transition: transform 0.2s;">
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <button onclick="alert('Redirecting to <?php echo e($hotel['vendor'] ?? 'partner'); ?> to complete your booking for <?php echo e(addslashes($hotel['name'])); ?>...')" class="btn btn-outline-primary rounded-pill px-4">Booking Now</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\HKU\ICOM6034\GroupProject\resources\views\travel_ideas\hotels.blade.php ENDPATH**/ ?>