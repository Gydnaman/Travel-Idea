...
<div class="hero-section text-center">
    <div class="container">
        ...
        <div class="mt-4">
            <a href="<?php echo e(route('travel-ideas.index')); ?>" class="btn btn-primary btn-lg px-5 py-3 shadow-lg fw-bold" style="border-radius: 50px; background: linear-gradient(135deg, #2193b0 0%, #6dd5ed 100%); border: 3px solid rgba(255,255,255,0.4); letter-spacing: 1px; transition: transform 0.2s; color: #fff;">
                <i class="bi bi-compass me-2"></i>Browse Ideas
            </a>
            <a href="<?php echo e(route('travel-ideas.advanced-search')); ?>" class="btn btn-primary btn-lg px-4 py-3 ms-3 fw-bold shadow-sm" style="border-radius: 50px; background: linear-gradient(135deg, #6dd5ed 0%, #2193b0 100%); border: 3px solid rgba(255,255,255,0.4); letter-spacing: 1px; transition: transform 0.2s; color: #fff;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\HKU\ICOM6034\TravelIdeas\GroupProject\resources\views/welcome.blade.php ENDPATH**/ ?>